<section class="contact-us lazyload parallax" data-bg="<?php echo get_template_directory_uri(); ?>/assets/images/contact.jpg">
    <div class="site-container contact-us__container">
